...
export default class Footer {
  ...
  public render(): void {
    const footer = createElement('footer', 'px-[2vw]', 'h-[8vh]', 'min-h-16', 'bg-base-100', 'flex', 'justify-around', 'items-center');
    footer.id = 'footer';

    const githubLinkFirst: HTMLLinkElement = createElement('a', 'w-[30px]', 'fill-secondary', 'hover:fill-primary-focus', 'transition', 'ease-in-out', 'delay-50');
    ...
    const githubLinkSecond: HTMLLinkElement = createElement('a', 'w-[30px]', 'fill-secondary', 'hover:fill-primary-focus', 'transition', 'ease-in-out', 'delay-50');
    ...
    const githubLinkThird: HTMLLinkElement = createElement('a', 'w-[30px]', 'fill-secondary', 'hover:fill-primary-focus', 'transition', 'ease-in-out', 'delay-50');
    ...
    const RsLink: HTMLLinkElement = createElement('a', 'w-[100px]', 'fill-secondary', 'hover:fill-primary-focus', 'transition', 'ease-in-out', 'delay-50', 'group');
