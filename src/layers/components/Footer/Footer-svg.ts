const enum FooterSVG {
  Github = `<svg class="github-link__svg" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
  <path
  ...
  Rsschool = ` <svg class="rsschool-link__svg" id="Layer_1" xmlns="http://www.w3.org/2000/svg"
