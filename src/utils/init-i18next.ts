    ...
    resources: {
      en: {
        translation: {
          ...
          boardCreateHint: 'must be between 3 and 20 characters',
          usersAdd: 'Add participants',
          imagesWrapper: 'Choose background or use url input',
          urlInput: 'Enter image link',
          boards: 'Boards',
      ...
      ru: {
        translation: {
          ...
          boardName: 'Название',
          boardDescription: 'Описание (опционально)',
          boardCreateHint: 'должно состоять от 3 до 20 символов',
          usersAdd: 'Добавить участников',
          imagesWrapper: 'Выберите фон или используйте поле ввода для ссылки',
          urlInput: 'Введите ссылку на изображение',
          boards: 'Доски',
          yourBoards: 'Ваши доски',
          starredBoards: 'Избранные доски',
          templates: 'Шаблоны',
        },
      },
      uk: {
        translation: {
          ...
          boardName: 'Назва',
          boardDescription: 'Опис (опціонально)',
          boardCreateHint: 'користувача має складатися від 3 до 20 символів',
          usersAdd: 'Додати учасників',
          imagesWrapper: 'Виберіть фон або скористайтеся полем введення для посилання',
          urlInput: 'Введіть посилання на зображення',
          boards: 'Дошки',
          yourBoards: 'Ваші дошки',
          starredBoards: 'Вибрані дошки',
          templates: 'Шаблони',
        },
      },
    },
